...
# 🔵 <span style="color:#1565C0">CLOUD INFRASTRUCTURE BLUEPRINT</span> 🔴
...
**Use in this mission:**
Used to identify the capacity of the root filesystem, such as `/dev/vda1`.
...
Root Filesystem: $(df -h / | awk 'NR==2 {print $2}') (/dev/vda1)
Mounted Filesystems:
